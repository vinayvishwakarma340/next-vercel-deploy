      ...
      {youtubeShow ? (
        <div>
          {props.isMobile ? (
            ...
            <iframe
              className={`sm:h-[120px] h-[150px] w-full  overflow-hidden rounded-lg`}
              src={props.url}
              frameborder="0"
        ...
        <div
          ...
          className={`relative sm:h-[120px]  h-[200px] w-auto cursor-pointer rounded-md overflow-hidden`}
        >
          <Image
            fill
