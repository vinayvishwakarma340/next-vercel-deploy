...
import Features from "../Components/Rozgaar/Features";
import FreelanceJobCard from "../Components/Rozgaar/FreelanceJobCard";
import { RiApi } from "./api/freelanceRiApi";
...
const freelancer = ({ props }) => {
    ...
    fetch(
      ...
      .then((result) => {
        if (
          ...
          result.message === "data submit successfully "
        ) {
          setShow(msg);
          setShowModal(true);
        }
  ...
  const closeModalHandler = () => {
    window.open("https://freelancer.rozgaarindia.com/", "_self");
    setShow(false);
  };
  const closeModal = () => {
    setShowModal(false);
  ...
  return (
    <>
      <Head>
        ...
        />
        <link rel="canonical" href="https://timesascent.com/freelancer" />
        ...
        <meta
          ...
          content="Read the Freelancer FAQ's to learn everything about Freelancing, freelance projects, remote work, contract work and gigs."
        />
        <meta property="og:url" content="https://timesascent.com/freelancer" />
        <meta
          property="og:image"
          content="https://timesascent.com/rozgaarindia/rozgaarhome.jpg"
        />
        <meta
      ...
      {/* <SuccessModal
        ...
        subHeadingText={`You will receive updates on all Job post.`}
        buttonText="OK"
      /> */}
      <FreelancerSuccessModal
        openModal={showModal}
        closeModal={() => closeModal()}
        Redirect="https://freelancer.rozgaarindia.com/"
        headingText="Thank-you !!"
        subHeadingText={show}
        buttonTextFirst="Redirect to page"
        buttonTextSecond="Close"
      />
      <MainHeader />
      ...
      <div className="bg-white">
        ...
        <main>
          {/* Hero section */}
          <div className="overflow-hidden pt-8 sm:pt-10 lg:relative lg:py-10">
            <div className="mx-auto lg:grid  lg:grid-cols-2 lg:gap-24 container">
              <div>
                <a
                  href="https://freelancer.rozgaarindia.com/"
                  target={"_self"}
                >
                  <img
                ...
                <div className="">
                  ...
                  <div className="mt-6 sm:max-w-xl">
                    ...
                    <p className="mt-6 text-xl text-gray-500">
                      Why work full time when you can work the way you want ?
                      Join the fastest growing freelance community and get
                      notified when a best suited job for you is posted.
                    </p>
                  </div>
                  {/* <form
                    onSubmit={(e) =>
                      Subscription(
                        e,
                        "We are redirecting you to R.I freelancers page"
                      )
                    }
                  ...
                  <a href="https://freelancer.rozgaarindia.com/"
                  ...
                  >
                    ...
                    <div
                      type="submit"
                      className="inline w-max m-auto rounded-md border border-transparent bg-rose-500 px-5 py-3 text-base font-medium text-white shadow hover:bg-rose-600 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 sm:px-10"
                    >
            ...
            <div className="sm:mx-auto sm:max-w-3xl sm:px-6">
              <div className="py-8 sm:relative sm:mt-12 sm:py-6 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                ...
                <div className="sm:relative -mr-40  sm:mx-auto sm:max-w-3xl sm:px-0 lg:h-full lg:max-w-none lg:pl-12">
                  <img
                    className="w-full rounded-md shadow-xl ring-1 ring-black ring-opacity-5 lg:h-full lg:w-auto lg:max-w-none"
                    src="/rozgaarindia/rozgaarhome.webp"
                    alt="RozgaarIndia"
                  />
                </div>
              </div>
          ...
          <FreelanceJobCard freelancerData={freelancerData} />
              ...
              <div className="lg:grid lg:grid-cols-2 lg:items-center lg:gap-24">
                <div>
                  <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                    Top Companies are embracing flexible work
                  </h2>
                  <p className="mt-6 max-w-3xl text-lg leading-7 text-gray-500">
                    Quick and Easy freelancer hiring Receive prioritised batches
                    of profiles so that you can stop wasting your time sorting
                    hundreds of applicants and connect, collaborate, pay and get
                    work done in a secure environment
                  </p>
                  <div className="mt-6">
                    <a
                      href="https://freelancer.rozgaarindia.com/"
                    ...
                    >
                      Trusted and Recognized by &rarr;
                    </a>
                  </div>
                </div>
                <div className="mt-12 grid grid-cols-1 gap-0.5 md:grid-cols-1 lg:mt-0 lg:grid-cols-1">
                  <RozgaarPartnerLogo />
                </div>
              </div>
            </div>
            ...
            <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:items-start lg:gap-24 lg:px-8">
                ...
                <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-none lg:px-0 lg:py-20">
                  ...
                  <div className="relative overflow-hidden rounded-2xl pt-64 pb-10 shadow-xl">
                    <img
                      ...
                      src="/RozgaarPartner/workcation.webp"
                      alt="Rozgaar_India_workcation"
                    />
                      ...
                      <blockquote className="mt-8">
                        <div className="relative text-lg font-medium text-white md:flex-grow">
                          ...
                          <p className="relative">
                            ...
                            yourself, you need a great team and a lot of help.
                            Thats what Rozgaar does for you. Helps you achieve
                            more in less time
                          </p>
                        </div>
              ...
              <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
                ...
                <div className="pt-12 sm:pt-16 lg:pt-20">
                  <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                    On a mission to empower work life
                  </h2>
                  <div className="mt-6 space-y-6 text-gray-500">
                    <p className="text-base leading-7">
                      We are on a mission to revolutionise freelancing. We match
                      professional freelancers with the top freelancing
                      requirements, making remote work more efficient than ever
                      before. A platform to find the right work for you, with
                      great clients, and get paid securely.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative">
                  <div className="sm:text-center">
                    ...
                    <p className="mx-auto mt-6 max-w-2xl text-lg text-rose-100">
                      We don't spam! We will only send you jobs and updates that
                  ...
                  <form
                    onSubmit={(e) =>
                      Subscription(
                        e,
                        "You will receive updates on all Job post."
                      )
                    }
...
export async function getServerSideProps(context) {
  const FreelanceData = await RiApi();
  const dataMain = FreelanceData.data;
  const props = {
    dataMain,
  };
