...
import { magazineApi } from "./api/generalApi";
import Head from "next/head";
const Flipbook = ({ props }) => {
  const pages = props.magazineData.data;
  ...
  return (
    <>
      <Head>
        <meta charSet="utf-8" />
        <title>Great Places To Work - 2022</title>
        <meta
          name="description"
        ...
        <link
          rel="canonical"
          href="https://timesascent.com/Great-Places-To-Work-2022"
        />
        ...
        <link
          ...
          href="https://timesascent.com/Times_Ascent_Icon.png"
        />
        <meta property="og:title" content=" Great Places To Work - 2022" />
        ...
        <meta
          property="og:url"
          content="https://timesascent.com/Great-Places-To-Work-2022"
        />
        <meta
          property="og:image"
        ...
        <meta
          ...
          content="https://timesascent.com/Times_Ascent_Icon.png"
        />
        <meta property="twitter:title" content="Great Places To Work - 2022" />
        <meta
      ...
      <div className={classes.head}>
        <div className={classes.head_div}>
          <h1 className="text-xl font-semibold mb-2">
            India's Best Companies To Work For -2022
          </h1>
        </div>
...
export async function getServerSideProps(context) {
  ...
  let props = {};
  try {
    const magazineData = await magazineApi({
      GPTWEditionID: "GPTW2022",
    });
    props = {
      isMobile,
      magazineData,
    ...
    console.log(err, "error in gptw page");
  }
