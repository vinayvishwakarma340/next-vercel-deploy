...
const LearnBestArticles = (props) => {
  const article = props.props.articledata.PaidArticles;
  const inspirationalStories =
    props.props.getForherSreenData.data.Inspirationalstories;
...
export default LearnBestArticles;
