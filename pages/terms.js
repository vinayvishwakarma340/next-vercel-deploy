...
const terms = () => {
  ...
  return (
    <div className=" relative">
      <Head>
        <meta charSet="utf-8" />
        <title>{`Terms Of Use for Job Seekers, Advertisers and Recruiters - TimesAscent.com`}</title>
        <meta
          name="description"
        ...
        />
        <link rel="canonical" href="https://timesascent.com/terms" />
        ...
        <meta
          ...
          content={`Get terms & conditions of usage Times Ascent for jobseekers, Advertisers & recruiters. The Site is owned, managed and operated by Bennett, Coleman & Co. Limited, Times Group`}
        />
        <meta property="og:url" content="https://timesascent.com/terms" />
        <meta
          property="og:image"
