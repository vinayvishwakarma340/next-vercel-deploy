...
const FreeCourses = ({ props }) => {
  ...
  const [coursestatus, setCoursestatus] = useState("Free");
  ...
  return (
    <div>
      ...
      <Head>
        ...
        />
        <link rel="canonical" href=" https://timesascent.com/free-courses" />
        ...
        <meta
          property="og:url"
          content=" https://timesascent.com/free-courses"
        />
        <meta
          property="og:image"
      ...
      <div className=" text-gray-500 container">
        ...
        <CourseFilter
          para={
            "Get access to unlimited free courses with our free courses section to boost your academic and professional learning to a whole new level of career accomplishments."
          }
