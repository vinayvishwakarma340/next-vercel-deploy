...
const SearchCourse = (props) => {
  // props.props.getAllCoursesdata.All_Courses
  ...
  const allCourses = props.props.getAllCoursesdata.All_Courses;
          ...
          <div className="left-side w-full  md:w-[calc(100%-320px)]">
            {article.length > 0 ? (
              ...
              <div className="font-medium text-lg">
                No result found for {searchArticle}
              </div>
            )}
